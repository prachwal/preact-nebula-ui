...
const DEBUG_CONFIG_PROVIDER = false

// Debug utility
const debug = (...args: any[]) => {
  if (DEBUG_CONFIG_PROVIDER) {
    console.log('[CONFIG PROVIDER DEBUG]', ...args)
  }
}
...
export const ConfigProvider = forwardRef<HTMLDivElement, ConfigProviderProps>((props, ref) => {
  ...
  const themeContextValue = useMemo((): ThemeContextValue => {
    ...
    if (cssVar && autoInsertCss) {
      ...
      debug('CSS variables would be generated with config:', cssVarConfig)
    }
