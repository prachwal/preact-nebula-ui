...
import { VariantsSection, SizesSection, StatesSection, FeaturesSection, ExamplesSection } from './sections';

interface PageProps {
  path?: string;
}

export default function TextareaPage(_props: PageProps) {
  return (
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-gray-600 dark:text-gray-300 mt-2">
                Multi-line text input with validation, sizing, and advanced features
              </p>
            </div>
          </div>
        </div>
