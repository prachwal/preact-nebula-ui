...
import { BasicUsageSection, VariantsSection, StructureSection, ExamplesSection } from './sections';

interface PageProps {
  path?: string;
}

export default function CardPage(_props: PageProps) {
  return (
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs defaultValue="basic">
          <TabList>
            ...
            <Tab value="variants">Card Variants</Tab>
            <Tab value="structure">Card Structure</Tab>
