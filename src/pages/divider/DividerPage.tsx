...
import { OrientationSection, VariantsSection, TextSection } from './sections'
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs defaultValue="orientation">
          <TabList>
            <Tab value="orientation">Orientation</Tab>
            <Tab value="variants">Line Variants</Tab>
            <Tab value="text">With Text</Tab>
          </TabList>

          <TabPanels>
            <TabPanel value="orientation">
              <OrientationSection />
            </TabPanel>
